"""
main.py is the menu loop. Talks to the user, delegates real work to MakerSpace.

Design rule is that there is no SQL and no business rules in here. If a rule changes, we edit
